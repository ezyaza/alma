$(document).ready(function() {
	...
	$('#second-step-button').click(function() {	
		...
		progressBar(0, $('#progressBarConsole'));
		$('.message-header h3').html("WSOP Generator");	
		$('.message-header p.message-header-subtitle').html("You are about to generate Chips");		
		$(".message-content p.console-message").fadeIn();	
		var $console_message_username_msg = $('#coc-player-tag').val();
		var $console_message_platform_msg = $('#coc-player-platform').val();
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Adding <span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Chips to <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {				
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Chips Added Successfully"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Adding <span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> Chips to <span class='console-message-connected-item'>"  + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {			
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> Chips Added Successfully"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit WSOP Chips generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Chips for himself haha');
